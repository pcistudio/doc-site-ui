...
image:https://github.com/pcistudio/doc-site-ui/actions/workflows/create-archetype.yml/badge.svg["Build Arcora Archetype", link=https://github.com/pcistudio/doc-site-ui/actions/workflows/create-archetype.yml]
